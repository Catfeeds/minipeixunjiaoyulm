...
class ProductController extends PublicController {
    ...
    public function index(){
		...
		$content = str_replace('/miniweddingcybl/Data/', __DATAURL__, $pro['content']);
   	...
   	public function lists(){
        ...
        if ($cityid>0) {
 		...
 		foreach ($product as $k => $v) {
 			...
 			$json['price']= floatval($v['price']);
 			$json['price_yh']=floatval($v['price_yh']);
