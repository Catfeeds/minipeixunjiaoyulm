...
-- ----------------------------
INSERT INTO `lr_adminuser` VALUES ('1', 'admin', '普通管理员', '5282f3c71ea6e0ce9064011a8bcd9e7b', '5', '1375086480', '0');
...
CREATE TABLE `lr_course` (
  ...
  `yu_price` decimal(9,2) DEFAULT '0.00' COMMENT '预付金',
  `photo` varchar(100) DEFAULT NULL COMMENT '图片',
  ...
  `teach_goals` varchar(200) DEFAULT NULL COMMENT '活动目的',
...
-- ----------------------------
-- Table structure for `lr_exhibition`
-- ----------------------------
DROP TABLE IF EXISTS `lr_exhibition`;
CREATE TABLE `lr_exhibition` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '展会表',
  `title` varchar(200) NOT NULL COMMENT '展会主题',
  `price` decimal(9,2) DEFAULT '0.00' COMMENT '报名费用',
  `photo` varchar(100) DEFAULT NULL COMMENT '列表展示图',
  `intro` varchar(255) DEFAULT NULL COMMENT '摘要',
  `opentime` int(11) DEFAULT '0' COMMENT '开始时间',
  `endtime` int(11) DEFAULT '0' COMMENT '结束时间',
  `address` varchar(150) DEFAULT NULL COMMENT '展会地址',
  `holder` varchar(200) DEFAULT NULL COMMENT '举办单位',
  `boothnum` int(11) DEFAULT '0' COMMENT '展位数量',
  `tel` char(15) DEFAULT NULL COMMENT '咨询热线',
  `email` char(20) DEFAULT NULL,
  `offtime` int(11) DEFAULT '0' COMMENT '报名截止时间',
  `addtime` int(11) DEFAULT '0' COMMENT '添加时间',
  `num` int(11) DEFAULT '0' COMMENT '报名企业数量',
  `del` tinyint(2) DEFAULT '0' COMMENT '删除状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_exhibition
-- ----------------------------
...
CREATE TABLE `lr_exshop` (
  ...
  `tjname` varchar(20) NOT NULL COMMENT '推荐人',
  `tjtel` char(15) NOT NULL COMMENT '推荐人手机',
  ...
  `audit_time` int(11) NOT NULL DEFAULT '0' COMMENT '提交审核时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `lr_hotcity_log`
-- ----------------------------
DROP TABLE IF EXISTS `lr_hotcity_log`;
CREATE TABLE `lr_hotcity_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '热门城市记录表',
  `uid` int(11) DEFAULT '0' COMMENT '点击会员ID',
  `cityid` int(11) NOT NULL DEFAULT '0' COMMENT '热门城市ID',
...
CREATE TABLE `lr_indeximg` (
  ...
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `ptype` char(10) NOT NULL COMMENT '用于前端跳转页面识别',
  `link` char(10) NOT NULL COMMENT '用于前端跳转事件区分',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `lr_indeximg` VALUES ('1', '0', '新闻资讯', 'UploadFiles/category/indeximg/20170626/1498465212860355.png', '1', 'news', 'other');
INSERT INTO `lr_indeximg` VALUES ('2', '0', '店铺列表', 'UploadFiles/category/indeximg/1500106288207591.png', '2', 'shop', 'other');
INSERT INTO `lr_indeximg` VALUES ('3', '0', '商家入驻', 'UploadFiles/category/indeximg/1500106414664017.png', '5', 'join', 'other');
INSERT INTO `lr_indeximg` VALUES ('4', '0', '关于我们', 'UploadFiles/category/indeximg/20170626/1498465246720048.png', '10', 'gywm', 'other');
INSERT INTO `lr_indeximg` VALUES ('5', '0', '交友专区', 'UploadFiles/category/indeximg/1500105826277882.png', '3', 'vip', 'other');
INSERT INTO `lr_indeximg` VALUES ('6', '0', '交友入驻', 'UploadFiles/category/indeximg/1500944059948828.png', '4', 'jyrz', 'other');
INSERT INTO `lr_indeximg` VALUES ('7', '0', '婚纱影楼', 'UploadFiles/category/indeximg/1500944071193159.png', '7', '1', 'list');
INSERT INTO `lr_indeximg` VALUES ('8', '0', '婚庆珠宝', 'UploadFiles/category/indeximg/1500944761980733.png', '8', '2', 'list');
INSERT INTO `lr_indeximg` VALUES ('9', '0', '婚庆基地', 'UploadFiles/category/indeximg/1500944787981095.png', '9', '3', 'list');
INSERT INTO `lr_indeximg` VALUES ('10', '0', '优惠券', 'UploadFiles/category/indeximg/1500944405792918.png', '6', 'vou', 'other');

-- ----------------------------
-- Table structure for `lr_life`
-- ----------------------------
DROP TABLE IF EXISTS `lr_life`;
CREATE TABLE `lr_life` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '会员生活专区记录表',
  `cid` int(11) DEFAULT '0' COMMENT '分类ID',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '店铺id',
  `name` varchar(200) DEFAULT NULL COMMENT '产品名称',
  `intro` varchar(255) DEFAULT NULL COMMENT '简介',
  `price` decimal(9,2) DEFAULT '0.00' COMMENT '价格',
  `salenum` int(11) DEFAULT '0' COMMENT '已有多少人购买',
  `img1` varchar(100) DEFAULT NULL,
  `img2` varchar(100) DEFAULT NULL,
  `img3` varchar(100) DEFAULT NULL,
  `click` int(11) DEFAULT '0' COMMENT '点击次数',
  `addtime` int(11) DEFAULT '0' COMMENT '添加时间',
  `tel` char(15) DEFAULT NULL COMMENT '联系方式',
  `zq_type` tinyint(2) DEFAULT '1' COMMENT '类型：1商品 2商家',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for `lr_life_cat`
-- ----------------------------
DROP TABLE IF EXISTS `lr_life_cat`;
CREATE TABLE `lr_life_cat` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '生活专区分类记录表',
...
CREATE TABLE `lr_order` (
  ...
  `order_type` tinyint(2) DEFAULT '1' COMMENT '订单类型 1普通订单 2课程订单',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '婚庆产业博览', '', '婚庆产业博览', 'UploadFiles/logo/1499152040916855.jpg', 'Copyright © 2017', 'wedii-org', '4006551365', '2872815158@qq.com', '1506148170');
...
CREATE TABLE `lr_shangchang` (
  ...
  `per_price` decimal(9,2) DEFAULT '0.00' COMMENT '多少元起',
...
-- ----------------------------
-- Table structure for `lr_sign_up`
-- ----------------------------
DROP TABLE IF EXISTS `lr_sign_up`;
CREATE TABLE `lr_sign_up` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '企业展位报名表',
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '提交会员ID',
  `eid` int(11) NOT NULL DEFAULT '0' COMMENT '展会ID',
  `company` varchar(100) DEFAULT NULL COMMENT '公司名称',
  `legal_person` varchar(10) DEFAULT NULL COMMENT '法人名字',
  `tel` char(15) DEFAULT NULL COMMENT '联系方式',
  `yyzz` varchar(100) DEFAULT NULL,
  `idcard` varchar(100) DEFAULT NULL,
  `addtime` int(11) DEFAULT '0' COMMENT '添加时间',
  `state` tinyint(2) DEFAULT '1' COMMENT '状态 1已报名待付款  2报名成功已付款',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_sign_up
-- ----------------------------
...
-- ----------------------------
-- Table structure for `lr_userinfo_log`
-- ----------------------------
DROP TABLE IF EXISTS `lr_userinfo_log`;
CREATE TABLE `lr_userinfo_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户信息记录表',
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '会员ID',
  ...
  `city` int(11) DEFAULT '0' COMMENT '居住城市',
  `hy` tinyint(2) DEFAULT '1' COMMENT '婚姻状况 1未婚  2离异  3丧偶',
  `sg` char(10) DEFAULT NULL COMMENT '身高',
  `xl` varchar(10) DEFAULT NULL COMMENT '学历',
  `yx` varchar(20) DEFAULT NULL COMMENT '月薪',
  `qq` varchar(20) DEFAULT NULL COMMENT 'QQ',
  `email` varchar(20) DEFAULT NULL COMMENT '邮箱',
  `weixin` varchar(30) DEFAULT NULL COMMENT '微信号',
  `tel` varchar(15) DEFAULT NULL COMMENT '联系方式',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `lxdx` varchar(255) DEFAULT NULL COMMENT '理想对象',
  `intro` varchar(255) DEFAULT NULL COMMENT '自我介绍',
  `zheng` varchar(100) DEFAULT NULL COMMENT '身份证正面',
  `fan` varchar(100) DEFAULT NULL COMMENT '身份证反面',
  `utype` tinyint(2) DEFAULT '1' COMMENT '开通会员类型 1普通会员 2高级会员 3钻石会员',
  `state` tinyint(1) DEFAULT '1' COMMENT '信息显示状态：1显示 0不显示',
  `addtime` int(11) DEFAULT '0' COMMENT '保存时间',
  `pay_state` tinyint(1) NOT NULL DEFAULT '0' COMMENT '支付状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_userinfo_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for `lr_user_info`
-- ----------------------------
DROP TABLE IF EXISTS `lr_user_info`;
CREATE TABLE `lr_user_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '会员信息发布记录',
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '会员ID',
  `adv_img` text COMMENT '图片数组',
  `content` varchar(255) DEFAULT NULL,
  `state` tinyint(2) DEFAULT '1' COMMENT '状态 1审核中 2 通过 3 未通过 4已删除',
  `addtime` int(11) DEFAULT '0' COMMENT '发布时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_user_info
-- ----------------------------

-- ----------------------------
-- Table structure for `lr_user_level`
-- ----------------------------
DROP TABLE IF EXISTS `lr_user_level`;
CREATE TABLE `lr_user_level` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户级别表',
  `name` varchar(10) NOT NULL COMMENT '级别名称',
  `price` decimal(9,2) DEFAULT '0.00' COMMENT '费用',
  `state` tinyint(1) DEFAULT '1' COMMENT '状态 1正常 0不显示',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_user_level
-- ----------------------------
...
-- Records of lr_web
-- ----------------------------
INSERT INTO `lr_web` VALUES ('1', '0', '关于我们', '', '0', '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 为了更好的帮助全国婚庆行业商家实现与会员之间的沟通，提高会员的选购保障，中国婚庆文化产业园推出商家店铺，在店面风格、模块管理、商品管理等消费保证体系，现正火热招商中，我们期待您的加入。<br /><p>　　“中国婚庆文化产业园”是专门为婚礼文化、婚庆服务、婚纱影楼、结婚用品、婚宴服务、婚宴用品、婚庆服饰、婚介交友服务、蜜月旅游、美容美发、婚庆珠宝首饰、保险理财、装修装潢、婚车婚房、汽车地产、文化传播等研究、经营、生产的企业和商家提供服务的网络交流平台。“婚庆行业互联网”致力于推介婚庆行业品牌、企业商家及婚礼主持人，提供小程序店铺展示，具备即时销售的网络平台功能。同时，也为广大准新人、以及婚庆业内各类别的新开业人士提供服务。让有需要的人士，通过小程序及时、快捷找到适合的婚庆企业商家。“中国婚庆文化产业园 ” 期待与广大民众一道，共同推进国内婚庆行业和谐发展、共同打造中国婚庆市场，提高婚庆行业品牌知名度!</p><p><img src=\"/miniweddingcybl/Data/UploadFiles/Uploads/day_170725/201707250952039710.jpg\" alt=\"\" /><br /></p>', '1500948372');
